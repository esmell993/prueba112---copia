...
<nav class="forma">
        <ul class="f">
            <li class="la"><a class="aa" href="admin_facturar.php">Inicio</a></li>
...
if (mysqli_num_rows($result_facturas) > 0) {
    while ($row_factura = mysqli_fetch_assoc($result_facturas)) {
        ...
        echo "<a class='imprimir-btn' href='admin_inprimir.php?cliente=" . $row_factura["nombre_cliente"] . "'>Imprimir</a>";
        echo "<a class='imprimir-btn' href='edit_admin.php?cliente=" . $row_factura["nombre_cliente"] . "'>Editar Factura</a>";
        echo "</div>";
    }
} else {
